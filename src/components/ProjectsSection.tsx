...
const projects = [
  ...
  {
    name: "Link Expander",
    description: "Telegram bot that expands Twitter, Instagram, TikTok, Dribbble, Reddit, Spotify, and HN links with inline video inside groups and channels.",
    stats: "215,000+ monthly active users",
  },
  {
    name: "Pixeldrop",
    description: "Redact sensitive information from your photos by pixelating them. Auto Face Detection. Auto Text Detection.",
