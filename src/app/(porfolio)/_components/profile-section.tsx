  ...
  return (
    ...
    >
      <div className="relative bio-text-shadow">
        <div
          className={cn(
            "hidden sm:block absolute bg-transparent top-5 right-[-300px] w-full h-full overflow-hidden",
          )}
        >
          <Orb
            hoverIntensity={0.5}
        ...
        <h1 className="custom-h1">
          LE ANH NGOC{" "}
          <span className="body-sm text-body-darker! transition-colors hover:text-white!">
            / @ngocla99
          </span>
        </h1>
